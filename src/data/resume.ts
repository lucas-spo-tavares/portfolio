...
export const skillGroups = [
  { id: "languages", items: ["JavaScript", "TypeScript", "Python", "SQL", "Dart", "HTML", "CSS", "Shell"] },
  { id: "frontend", items: ["React", "Next.js", "Vue", "Angular", "Tailwind", "shadcn/ui", "PrimeVue"] },
  { id: "backend", items: ["Node.js", "Nest.js", "Express", "Django", "TypeORM"] },
  { id: "infra", items: ["AWS", "Docker", "GitHub", "Bitbucket", "GraphQL", "REST", "Linux"] },
] as const;
